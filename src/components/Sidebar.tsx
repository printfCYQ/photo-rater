  ...
  return (
    <aside className="w-[260px] bg-surface flex flex-col flex-shrink-0 border-r border-base-800/60 relative z-10">
      ...
      <div className="px-3.5 py-3 border-t border-base-800/60">
        <button
          className="flex items-center gap-2 w-full py-2 px-2.5 rounded-md text-[12px] text-base-500
            hover:text-base-300 hover:bg-surface-alt transition-colors duration-150"
